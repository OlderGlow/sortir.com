 ...
 */
final class Version20200810131821 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE participants (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(30) NOT NULL, nom VARCHAR(80) NOT NULL, prenom VARCHAR(80) NOT NULL, telephone VARCHAR(10) DEFAULT NULL, mail VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, roles JSON NOT NULL, actif TINYINT(1) NOT NULL, photo VARCHAR(255) DEFAULT NULL, Campus INT DEFAULT NULL, INDEX IDX_716970929AA56D27 (Campus), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE participants ADD CONSTRAINT FK_716970929AA56D27 FOREIGN KEY (Campus) REFERENCES campus (id)');
